...
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#
# parachute.py -- punish late opening of parachutes
#
...
class parachute(base):
    ...
    def round_start(self, hooker):
        hooker.register('EnterVehicle', self.vehicleEntered)
        hooker.register('ExitVehicle', self.vehicleExited)
    
    def vehicleEntered(self, player, vehicle, *args):
        if vehicle.templateName.lower() in vehicleMetadata.parachutes:
            player.parachuteStart = host.timer_getWallTime()
    
    def vehicleExited(self, player, vehicle):
        if vehicle.templateName.lower() in vehicleMetadata.parachutes:
            end = host.timer_getWallTime()
            diff = end - player.parachuteStart
            
            if DEBUG: print player.getName(), 'spent', diff, 'seconds in chute'
